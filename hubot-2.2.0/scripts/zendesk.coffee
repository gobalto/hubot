...
#
# Commands:
#   (all) tickets - returns the total count of all unsolved tickets on ZenDesk. The 'all'
#                   keyword is optional.
#   new tickets - returns the count of all new tickets on ZenDesk
#   open tickets - returns the count of all open tickets on ZenDesk
#   list (all) tickets - returns a list of all unsolved tickets on ZenDesk. The 'all'
#                   keyword is optional.
#   list new tickets - returns a list of all new tickets on ZenDesk
#   list open tickets - returns a list of all open tickets on ZenDesk
#   ticket <ID> - returns informationa about the specified ticket on ZenDesk
#   hubot find ticket <string> - searches ZenDesk for all Tickets matching <string> and prints them

# Author:
#   Ben Lopatin (bennylope), Abraham Polishchuk (apolishc)
...
#  robot.respond /show zendesk user/i, (msg) ->
#    user_id = msg.match[1]
#    zendesk_user msg, user_id
